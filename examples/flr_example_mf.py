...
def parse_args():
    ...
    parser.add_argument("--workspace_path", type=str, default= "workspace/test", help="Path to save the workspace.")
    ...
    parser.add_argument("--loss_fun_name", type=str, default="pairwise_logistic_loss", help="Loss function to use.")
