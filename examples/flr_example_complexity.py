...
def parse_args():
    ...
    parser.add_argument("--workspace_path", type=str, default= "workspace/complexity_pred", help="Path to save the workspace.")
...
if __name__ == "__main__":
    ...
    train_dataset = PromptComplexityDataset(dataset_name, split="train", test_size=test_size, random_sample=True)
    model_list = train_dataset.collect_models()
   
    eval_dataset = PromptComplexityDataset(dataset_name, split="test", 
